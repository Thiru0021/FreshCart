...
<head>
    ...
    <title>Edit Sub Category - Grocery Admin</title>
    ...
    <style>
        * {
        ...
        /* Sleek Modern Form Card Container */
        .form-container {
            background: #ffffff;
            max-width: 600px;
            padding: 30px;
...
<div class="main-content">
    ...
    <div class="header">
        ...
        <a href="view_subcategory.php" class="back-btn">&larr; Cancel</a>
    </div>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="category_id" name="category_id" required>
                    ...
                    {
                    ?>
                        <option value="<?php echo $cat['category_id']; ?>" <?php if($row['category_id'] == $cat['category_id']) echo "selected"; ?>>
            ...
            <div class="form-group">
                ...
                <input type="text" id="sub_category_name" name="sub_category_name" value="<?php echo $row['sub_category_name']; ?>" required>
            </div>

            <div class="form-group">
                <label>Current Saved Image</label>
                <div class="current-image-box">
                    <img src="../images/<?php echo $row['image']; ?>" width="80" height="80" alt="Current Subcategory Image">
                </div>
            </div>
            ...
            <input type="submit" name="update" value="Update Sub Category" class="update-btn">
