...
<head>
    ...
    <title>Sub Category List - Grocery Admin</title>
    ...
    <div class="profile-container" onclick="window.location.href='<?php echo (file_exists('profile.php') ? '' : '../'); ?>profile.php';">
        ...
        <div class="main-content">
            ...
            <div class="header">
                ...
                <a href="add_subcategory.php" class="add-btn">+ Add Sub Category</a>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="text-muted"><?php echo $row['category_id']; ?></span></td>
                            <td><?php echo $row['sub_category_name']; ?></td>
                            <td>
                                <img class="subcategory-img" src="../images/<?php echo $row['image']; ?>" width="60" height="60" alt="SubCategory Image">
                            </td>
                            <td>
                                <a href="edit_subcategory.php?id=<?php echo $row['id']; ?>" class="action-link edit-link">Edit</a>
                                <a href="delete_subcategory.php?id=<?php echo $row['id']; ?>" class="action-link delete-link" onclick="return confirm('Are you sure you want to delete this Sub Category?');">Delete</a>
                    </td>
                        </tr>
                        <?php
                        }
